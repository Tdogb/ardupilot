...
AP_Airspeed_Tornado::AP_Airspeed_Tornado(AP_Airspeed &_frontend, uint8_t _instance, uint8_t _tornado_array_index) :
    AP_Airspeed_Backend(_frontend, _instance)
{
    tornado_array_index = _tornado_array_index;
}

// probe for a sensor
bool AP_Airspeed_Tornado::probe(uint8_t bus, uint8_t address)
{
...
found_sensor:
    ...
    _dev->register_periodic_callback(20000,
                                     FUNCTOR_BIND_MEMBER(&AP_Airspeed_Tornado::_timer, void));
    return true;
}

// start a measurement
void AP_Airspeed_Tornado::_measure()
{
...
*/
float AP_Airspeed_Tornado::_get_pressure(int16_t dp_raw) const
{
 ...
 */
float AP_Airspeed_Tornado::_get_temperature(int16_t dT_raw) const
{
...
void AP_Airspeed_Tornado::_collect()
{
    uint8_t data[4];
    uint8_t data2[4];
 ...
 */
void AP_Airspeed_Tornado::_voltage_correction(float &diff_press_pa, float &temperature)
{
...
// 50Hz timer
void AP_Airspeed_Tornado::_timer()
{
...
bool AP_Airspeed_Tornado::get_differential_pressure(float &pressure)
{
    WITH_SEMAPHORE(sem);
...
bool AP_Airspeed_Tornado::get_temperature(float &temperature)
{
    WITH_SEMAPHORE(sem);
